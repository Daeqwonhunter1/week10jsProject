/* Movies */
let movies = [
	{name:"Luffy",img:"https://static.wikia.nocookie.net/onepiece-fairytail/images/5/5f/Monkey_D._Luffy.png"},
	{name:"Zoro",img:"https://static.wikia.nocookie.net/onepiece-fairytail/images/5/50/Roronoa_Zoro.png"},
	{name:"Nami",img:"https://static.wikia.nocookie.net/onepiece-fairytail/images/d/dd/Nami.png"},
	{name:"Usopp",img:"https://static.wikia.nocookie.net/onepiece-fairytail/images/5/53/Usopp.png"},
	{name:"Sanji",img:"https://static.wikia.nocookie.net/onepiece-fairytail/images/4/48/Sanji.png"},
	{name:"Chopper",img:"https://static.wikia.nocookie.net/onepiece-fairytail/images/6/66/Tony_Tony_Chopper.png"},
	{name:"Robin",img:"https://static.wikia.nocookie.net/onepiece-fairytail/images/0/06/Nico_Robin.png"},
	{name:"Franky",img:"https://static.wikia.nocookie.net/onepiece-fairytail/images/3/35/Franky.png"},
	{name:"Brook",img:"https://static.wikia.nocookie.net/onepiece-fairytail/images/5/55/Brook.png"},
];
...
function Game()
{
	...
	document.getElementById("d").style.backgroundImage = `url(${wordImg})`
	let guessedLetters = [];
	let maskedWord = "";
